...
import controlador.MonedasController;


public class FrmMonedas extends JInternalFrame implements ActionListener, KeyListener{
    ...
    public void setController(MonedasController controller) {
	 ...
	 */
	public FrmMonedas() {
		setFrameIcon(new ImageIcon(FrmMonedas.class.getResource("/imagenes/icono-monedas.png")));
		setIconifiable(true);
		setClosable(true);
		...
		cboUnidadInicio.setModel(new DefaultComboBoxModel(new String[] {"Soles (S/)", "Dólares ($)", "Euros (Є)", "Libras Esterlinas (£)", "Yenes (¥)", "Wons (₩)"}));
		...
		cboUnidadFin.setModel(new DefaultComboBoxModel(new String[] {"Soles (S/)", "Dólares ($)", "Euros (Є)", "Libras Esterlinas (£)", "Yenes (¥)", "Wons (₩)"}));
		...
		btnConvertir.setIcon(new ImageIcon(FrmMonedas.class.getResource("/imagenes/icono-resetear.png")));
		...
		btnCerrar.setIcon(new ImageIcon(FrmMonedas.class.getResource("/imagenes/icono-cerrar.png")));
		...
		btnBorrar.setIcon(new ImageIcon(FrmMonedas.class.getResource("/imagenes/icono-borrar.png")));
		...
		lblBackground.setIcon(new ImageIcon(FrmMonedas.class.getResource("/imagenes/fondo_ventanas.gif")));
