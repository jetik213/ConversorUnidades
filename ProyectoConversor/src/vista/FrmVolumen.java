...
import controlador.VolumenController;


public class FrmVolumen extends JInternalFrame implements ActionListener, KeyListener{
	...
	private VolumenController controller;

	
    public void setController(VolumenController controller) {
	 ...
	 */
	public FrmVolumen() {
		setFrameIcon(new ImageIcon(FrmVolumen.class.getResource("/imagenes/icono-volumen.png")));
		setIconifiable(true);
		setClosable(true);
		...
		cboUnidadInicio.setModel(new DefaultComboBoxModel(new String[] {"Litros (l)", "Mililitros (ml)", "Galones (gal)", "Pies Cúbicos (ft3)", "Onzas Líquidas (oz)"}));
		...
		cboUnidadFin.setModel(new DefaultComboBoxModel(new String[] {"Litros (l)", "Mililitros (ml)", "Galones (gal)", "Pies Cúbicos (ft3)", "Onzas Líquidas (oz)"}));
		...
		btnConvertir.setIcon(new ImageIcon(FrmVolumen.class.getResource("/imagenes/icono-resetear.png")));
		...
		btnCerrar.setIcon(new ImageIcon(FrmVolumen.class.getResource("/imagenes/icono-cerrar.png")));
		...
		btnBorrar.setIcon(new ImageIcon(FrmVolumen.class.getResource("/imagenes/icono-borrar.png")));
		...
		lblBackground.setIcon(new ImageIcon(FrmVolumen.class.getResource("/imagenes/fondo_ventanas.gif")));
