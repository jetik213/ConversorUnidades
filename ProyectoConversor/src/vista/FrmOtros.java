...
import controlador.OtrosController;


public class FrmOtros extends JInternalFrame implements ActionListener, KeyListener{
	...
	private OtrosController controller;

	
    public void setController(OtrosController controller) {
	 ...
	 */
	public FrmOtros() {
		setFrameIcon(new ImageIcon(FrmOtros.class.getResource("/imagenes/icono-otros.png")));
		setIconifiable(true);
		setClosable(true);
		setTitle("Conversor Variado");
		...
		cboUnidadInicio.setModel(new DefaultComboBoxModel(new String[] {"Cucharadas", "Cucharaditas", "Tazas", "Tacitas", "Pintas"}));
		cboUnidadInicio.setBounds(130, 20, 197, 20);
		contentPane.add(cboUnidadInicio);
		
		cboUnidadFin = new JComboBox<String>();
		cboUnidadFin.addActionListener(this);
		cboUnidadFin.setModel(new DefaultComboBoxModel(new String[] {"Cucharas y Cucharitas", "Tazas y Tacitas", "Mililitros"}));
		...
		cboUnidadFin.setBounds(130, 50, 197, 20);
		...
		btnConvertir.setIcon(new ImageIcon(FrmOtros.class.getResource("/imagenes/icono-resetear.png")));
		...
		btnCerrar.setIcon(new ImageIcon(FrmOtros.class.getResource("/imagenes/icono-cerrar.png")));
		btnCerrar.setBounds(338, 20, 110, 40);
		...
		btnBorrar.setIcon(new ImageIcon(FrmOtros.class.getResource("/imagenes/icono-borrar.png")));
		...
		lblBackground.setIcon(new ImageIcon(FrmOtros.class.getResource("/imagenes/fondo_ventanas.gif")));
