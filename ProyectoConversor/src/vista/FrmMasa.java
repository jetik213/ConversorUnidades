...
import controlador.MasaController;


public class FrmMasa extends JInternalFrame implements ActionListener, KeyListener{
    ...
    public void setController(MasaController controller) {
	 ...
	 */
	public FrmMasa() {
		setFrameIcon(new ImageIcon(FrmMasa.class.getResource("/imagenes/icono-masa.png")));
		setIconifiable(true);
		setClosable(true);
		...
		cboUnidadInicio.setModel(new DefaultComboBoxModel(new String[] {"Kilogramos (Kg)", "Gramos (g)", "Toneladas (t)", "Libras (lb)", "Onzas (Oz)"}));
		...
		cboUnidadFin.setModel(new DefaultComboBoxModel(new String[] {"Kilogramos (Kg)", "Gramos (g)", "Toneladas (t)", "Libras (lb)", "Onzas (Oz)"}));
		...
		btnConvertir.setIcon(new ImageIcon(FrmMasa.class.getResource("/imagenes/icono-resetear.png")));
		...
		btnCerrar.setIcon(new ImageIcon(FrmMasa.class.getResource("/imagenes/icono-cerrar.png")));
		...
		btnBorrar.setIcon(new ImageIcon(FrmMasa.class.getResource("/imagenes/icono-borrar.png")));
		...
		lblBackground.setIcon(new ImageIcon(FrmMasa.class.getResource("/imagenes/fondo_ventanas.gif")));
